...
class Line(object):
    ...
    def line_plus(self, other_line):
        ...
        #        They include the Example in the above doc-string.
        # ---------------------------------------------------------------------
        start_new_x = self.start.x + other_line.start.x
        start_new_y = self.start.y + other_line.start.y
        end_new_x = self.end.x + other_line.end.x
        end_new_y = self.end.y + other_line.end.y
        return Line(Point(start_new_x, start_new_y), Point(end_new_x, end_new_y))
    ...
    def is_parallel(self, line2):
        ...
        #######################################################################
        # print(round(self.slope(), 12))
        # print(round(line2.slope(), 12))
